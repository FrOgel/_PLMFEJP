                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0;">
                      Your current contract proposals for your contracts!
                    </td>
                  </tr>
                </table>
              </td>
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
							...
							<p>Contract <b><%= subject %></b>  (#Ref. <%= contractId %>) <a href="https://localhost:8443/ContractManagement/rest/contract/contracts/<%= contractId %>"> Check out contract <%= contractId %></a></p>
                          </td>
                        </tr>
                      </table>
                    </td>
