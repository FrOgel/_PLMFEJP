                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0;">
                      You were <%= request.getParameter("accept") %> as a candidate for contract <b> <%= request.getParameter("name") %> (#Ref: <%= request.getParameter("id") %>)</b>
                    </td>
                  </tr>
                </table>
              </td>
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
                            <a href="https://localhost:8443/ContractManagement/rest/contract/contracts/<%= request.getParameter("id") %>">Go to contract.</a>
                          </td>
                        </tr>
                      </table>
                    </td>
