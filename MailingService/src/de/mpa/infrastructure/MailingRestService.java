...
/**
 * @author frank.vogel Date: 06.01.2018 Purpose: Encapsulate the rest endpoint
...
public class MailingRestService implements _ApplicationMailingService {
	...
	public void sendVerificationMail(@PathParam("to") String to, @PathParam("id") String id,
