            ...
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy">
                       In order to complete your registration please verify your account by clicking the button "Verify!".
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
                            <a href="https://localhost:8443/IdentityManagement/rest/user/passwordResetAuthentication/<%= request.getParameter("hash") %>">ChangePassword!</a>
                          </td>
                        </tr>
                      </table>
                    </td>
